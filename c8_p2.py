...
'''
load_file = '/d/users/kgalbraith/PHYS4840_labs/MIST_v1.2_feh_m1.75_afe_p0.0_vvcrit0.4_HST_WFPC2.iso.cmd'
...
'''
filename = '/d/users/kgalbraith/PHYS4840_labs/NGC6341.dat'
...
d=mfl.distance(8.63)
ax.plot(cleaned_color, cleaned_magnitude+d, 'go', markersize=2, linestyle='-', label='Isochrone Model')
